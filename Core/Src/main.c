...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, RC522_RST_Pin|RC522_CS_Pin|MAGNET_CTRL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RC522_RST_Pin RC522_CS_Pin MAGNET_CTRL_Pin */
  GPIO_InitStruct.Pin = RC522_RST_Pin|RC522_CS_Pin|MAGNET_CTRL_Pin;
